...
out:
	MALI_GRALLOC_LOGV("%s: alloc_format=(%s 0x%" PRIx64 ") usage=0x%" PRIx64
...
out:
	MALI_GRALLOC_LOGV("%s: req_format=(%s 0x%08" PRIx64 "), usage=0x%" PRIx64
	      ", req_base_format=(%s 0x%" PRIx32 "), alloc_format=(%s, 0x%" PRIx64 ")", __func__,
	      format_name(req_format), req_format, usage,
